...
func (c *phonesClient) ListPhones(ctx context.Context, in *ListPhonesRequest, opts ...grpc.CallOption) (*PhoneList, error) {
	out := new(PhoneList)
	err := c.cc.Invoke(ctx, Phones_ListPhones_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *phonesClient) MergePhones(ctx context.Context, in *MergePhonesRequest, opts ...grpc.CallOption) (*PhoneList, error) {
	out := new(PhoneList)
	err := c.cc.Invoke(ctx, Phones_MergePhones_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *phonesClient) ResetPhones(ctx context.Context, in *ResetPhonesRequest, opts ...grpc.CallOption) (*PhoneList, error) {
	out := new(PhoneList)
	err := c.cc.Invoke(ctx, Phones_ResetPhones_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
var Phones_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "gateway/contacts/phones.proto",
}
