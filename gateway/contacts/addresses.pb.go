...
// 	protoc        v3.21.6
// source: gateway/contacts/addresses.proto
...
// https://developers.google.com/pefieldsople/api/rest/v1/people#address
type Address struct {
...
func (x *Address) Reset() {
	*x = Address{}
	if protoimpl.UnsafeEnabled {
		mi := &file_gateway_contacts_addresses_proto_msgTypes[0]
...
func (*Address) Descriptor() ([]byte, []int) {
	return file_gateway_contacts_addresses_proto_rawDescGZIP(), []int{0}
}
...
func (x *InputAddress) Reset() {
	*x = InputAddress{}
	if protoimpl.UnsafeEnabled {
		mi := &file_gateway_contacts_addresses_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*InputAddress) Descriptor() ([]byte, []int) {
	return file_gateway_contacts_addresses_proto_rawDescGZIP(), []int{1}
}
...
func (x *AddressList) Reset() {
	*x = AddressList{}
	if protoimpl.UnsafeEnabled {
		mi := &file_gateway_contacts_addresses_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*AddressList) Descriptor() ([]byte, []int) {
	return file_gateway_contacts_addresses_proto_rawDescGZIP(), []int{2}
}
...
var File_gateway_contacts_addresses_proto protoreflect.FileDescriptor

var file_gateway_contacts_addresses_proto_rawDesc = []byte{
	0x0a, 0x20, 0x67, 0x61, 0x74, 0x65, 0x77, 0x61, 0x79, 0x2f, 0x63, 0x6f, 0x6e, 0x74, 0x61, 0x63,
	0x74, 0x73, 0x2f, 0x61, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x65, 0x73, 0x2e, 0x70, 0x72, 0x6f,
...
var (
	file_gateway_contacts_addresses_proto_rawDescOnce sync.Once
	file_gateway_contacts_addresses_proto_rawDescData = file_gateway_contacts_addresses_proto_rawDesc
)

func file_gateway_contacts_addresses_proto_rawDescGZIP() []byte {
	file_gateway_contacts_addresses_proto_rawDescOnce.Do(func() {
		file_gateway_contacts_addresses_proto_rawDescData = protoimpl.X.CompressGZIP(file_gateway_contacts_addresses_proto_rawDescData)
	})
	return file_gateway_contacts_addresses_proto_rawDescData
}

var file_gateway_contacts_addresses_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_gateway_contacts_addresses_proto_goTypes = []interface{}{
...
var file_gateway_contacts_addresses_proto_depIdxs = []int32{
...
func init() { file_gateway_contacts_addresses_proto_init() }
func file_gateway_contacts_addresses_proto_init() {
	if File_gateway_contacts_addresses_proto != nil {
		return
	}
	file_gateway_contacts_fields_proto_init()
	if !protoimpl.UnsafeEnabled {
		file_gateway_contacts_addresses_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_gateway_contacts_addresses_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_gateway_contacts_addresses_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_gateway_contacts_addresses_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_gateway_contacts_addresses_proto_goTypes,
		DependencyIndexes: file_gateway_contacts_addresses_proto_depIdxs,
		MessageInfos:      file_gateway_contacts_addresses_proto_msgTypes,
	}.Build()
	File_gateway_contacts_addresses_proto = out.File
	file_gateway_contacts_addresses_proto_rawDesc = nil
	file_gateway_contacts_addresses_proto_goTypes = nil
	file_gateway_contacts_addresses_proto_depIdxs = nil
}
