...
var file_member_proto_rawDesc = []byte{
	...
	0x52, 0x03, 0x69, 0x64, 0x73, 0x22, 0x99, 0x05, 0x0a, 0x1a, 0x53, 0x65, 0x61, 0x72, 0x63, 0x68,
	...
	0x49, 0x64, 0x12, 0x4f, 0x0a, 0x09, 0x76, 0x61, 0x72, 0x69, 0x61, 0x62, 0x6c, 0x65, 0x73, 0x18,
	0x12, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x31, 0x2e, 0x65, 0x6e, 0x67, 0x69, 0x6e, 0x65, 0x2e, 0x53,
	...
	0x01, 0x22, 0x4d, 0x0a, 0x0a, 0x4c, 0x69, 0x73, 0x74, 0x4d, 0x65, 0x6d, 0x62, 0x65, 0x72, 0x12,
	...
	0x28, 0x0b, 0x32, 0x15, 0x2e, 0x65, 0x6e, 0x67, 0x69, 0x6e, 0x65, 0x2e, 0x4d, 0x65, 0x6d, 0x62,
	0x65, 0x72, 0x49, 0x6e, 0x51, 0x75, 0x65, 0x75, 0x65, 0x52, 0x05, 0x69, 0x74, 0x65, 0x6d, 0x73,
	...
	0x01, 0x28, 0x09, 0x52, 0x04, 0x64, 0x74, 0x6d, 0x66, 0x32, 0xc2, 0x11, 0x0a, 0x0d, 0x4d, 0x65,
	...
	0x65, 0x6e, 0x74, 0x65, 0x72, 0x2f, 0x6d, 0x65, 0x6d, 0x62, 0x65, 0x72, 0x73, 0x12, 0x7d, 0x0a,
	...
	0x6d, 0x62, 0x65, 0x72, 0x73, 0x2f, 0x72, 0x65, 0x73, 0x65, 0x74, 0x12, 0x9b, 0x01, 0x0a, 0x14,
	...
	0x65, 0x6d, 0x70, 0x74, 0x73, 0x2f, 0x61, 0x63, 0x74, 0x69, 0x76, 0x65, 0x12, 0x80, 0x01, 0x0a,
	...
	0x72, 0x5f, 0x69, 0x64, 0x7d, 0x2f, 0x61, 0x74, 0x74, 0x65, 0x6d, 0x70, 0x74, 0x73, 0x42, 0x22,
...
var file_member_proto_msgTypes = make([]protoimpl.MessageInfo, 45)
var file_member_proto_goTypes = []interface{}{
	...
	nil,                                      // 42: engine.SearchMemberInQueueRequest.VariablesEntry
	nil,                                      // 43: engine.CreateMemberRequest.VariablesEntry
	nil,                                      // 44: engine.MemberInQueue.VariablesEntry
	(*Lookup)(nil),                           // 45: engine.Lookup
	(*FilterBetween)(nil),                    // 46: engine.FilterBetween
...
var file_member_proto_depIdxs = []int32{
	...
	45, // 1: engine.PatchMemberRequest.timezone:type_name -> engine.Lookup
	32, // 2: engine.PatchMemberRequest.communications:type_name -> engine.MemberCommunicationCreateRequest
	45, // 3: engine.PatchMemberRequest.bucket:type_name -> engine.Lookup
	45, // 4: engine.PatchMemberRequest.agent:type_name -> engine.Lookup
	45, // 5: engine.PatchMemberRequest.skill:type_name -> engine.Lookup
	...
	45, // 10: engine.AttemptHistory.queue:type_name -> engine.Lookup
	45, // 11: engine.AttemptHistory.member:type_name -> engine.Lookup
	36, // 12: engine.AttemptHistory.variables:type_name -> engine.AttemptHistory.VariablesEntry
	45, // 13: engine.AttemptHistory.agent:type_name -> engine.Lookup
	45, // 14: engine.AttemptHistory.resource:type_name -> engine.Lookup
	45, // 15: engine.AttemptHistory.bucket:type_name -> engine.Lookup
	45, // 16: engine.AttemptHistory.list:type_name -> engine.Lookup
	31, // 17: engine.AttemptHistory.destination:type_name -> engine.MemberCommunication
	45, // 18: engine.Attempt.queue:type_name -> engine.Lookup
	45, // 19: engine.Attempt.member:type_name -> engine.Lookup
	37, // 20: engine.Attempt.variables:type_name -> engine.Attempt.VariablesEntry
	45, // 21: engine.Attempt.agent:type_name -> engine.Lookup
	45, // 22: engine.Attempt.resource:type_name -> engine.Lookup
	45, // 23: engine.Attempt.bucket:type_name -> engine.Lookup
	45, // 24: engine.Attempt.list:type_name -> engine.Lookup
	31, // 25: engine.Attempt.destination:type_name -> engine.MemberCommunication
	46, // 26: engine.SearchAttemptsRequest.joined_at:type_name -> engine.FilterBetween
	46, // 27: engine.SearchAttemptsRequest.leaving_at:type_name -> engine.FilterBetween
	46, // 28: engine.SearchAttemptsRequest.offering_at:type_name -> engine.FilterBetween
	46, // 29: engine.SearchAttemptsRequest.duration:type_name -> engine.FilterBetween
	46, // 30: engine.SearchMembersRequest.created_at:type_name -> engine.FilterBetween
	46, // 31: engine.SearchMembersRequest.offering_at:type_name -> engine.FilterBetween
	46, // 32: engine.SearchMembersRequest.priority:type_name -> engine.FilterBetween
	46, // 33: engine.SearchMembersRequest.attempts:type_name -> engine.FilterBetween
	46, // 34: engine.DeleteMembersRequest.created_at:type_name -> engine.FilterBetween
	46, // 35: engine.DeleteMembersRequest.offering_at:type_name -> engine.FilterBetween
	46, // 36: engine.DeleteMembersRequest.priority:type_name -> engine.FilterBetween
	46, // 37: engine.DeleteMembersRequest.attempts:type_name -> engine.FilterBetween
	...
	45, // 41: engine.MemberAttempt.member:type_name -> engine.Lookup
	45, // 42: engine.MemberAttempt.resource:type_name -> engine.Lookup
	45, // 43: engine.MemberAttempt.agent:type_name -> engine.Lookup
	45, // 44: engine.MemberAttempt.bucket:type_name -> engine.Lookup
	47, // 45: engine.MemberAttempt.logs:type_name -> google.protobuf.Value
	40, // 46: engine.UpdateMemberRequest.variables:type_name -> engine.UpdateMemberRequest.VariablesEntry
	45, // 47: engine.UpdateMemberRequest.timezone:type_name -> engine.Lookup
	32, // 48: engine.UpdateMemberRequest.communications:type_name -> engine.MemberCommunicationCreateRequest
	45, // 49: engine.UpdateMemberRequest.bucket:type_name -> engine.Lookup
	45, // 50: engine.UpdateMemberRequest.agent:type_name -> engine.Lookup
	45, // 51: engine.UpdateMemberRequest.skill:type_name -> engine.Lookup
	...
	45, // 54: engine.CreateMemberBulkItem.timezone:type_name -> engine.Lookup
	32, // 55: engine.CreateMemberBulkItem.communications:type_name -> engine.MemberCommunicationCreateRequest
	45, // 56: engine.CreateMemberBulkItem.bucket:type_name -> engine.Lookup
	45, // 57: engine.CreateMemberBulkItem.agent:type_name -> engine.Lookup
	45, // 58: engine.CreateMemberBulkItem.skill:type_name -> engine.Lookup
	46, // 59: engine.SearchMemberInQueueRequest.created_at:type_name -> engine.FilterBetween
	46, // 60: engine.SearchMemberInQueueRequest.offering_at:type_name -> engine.FilterBetween
	46, // 61: engine.SearchMemberInQueueRequest.priority:type_name -> engine.FilterBetween
	46, // 62: engine.SearchMemberInQueueRequest.attempts:type_name -> engine.FilterBetween
	42, // 63: engine.SearchMemberInQueueRequest.variables:type_name -> engine.SearchMemberInQueueRequest.VariablesEntry
	30, // 64: engine.ListMember.items:type_name -> engine.MemberInQueue
	43, // 65: engine.CreateMemberRequest.variables:type_name -> engine.CreateMemberRequest.VariablesEntry
	45, // 66: engine.CreateMemberRequest.timezone:type_name -> engine.Lookup
	32, // 67: engine.CreateMemberRequest.communications:type_name -> engine.MemberCommunicationCreateRequest
	45, // 68: engine.CreateMemberRequest.bucket:type_name -> engine.Lookup
	45, // 69: engine.CreateMemberRequest.agent:type_name -> engine.Lookup
	45, // 70: engine.CreateMemberRequest.skill:type_name -> engine.Lookup
	45, // 71: engine.MemberInQueue.queue:type_name -> engine.Lookup
	44, // 72: engine.MemberInQueue.variables:type_name -> engine.MemberInQueue.VariablesEntry
	45, // 73: engine.MemberInQueue.timezone:type_name -> engine.Lookup
	31, // 74: engine.MemberInQueue.communications:type_name -> engine.MemberCommunication
	45, // 75: engine.MemberInQueue.bucket:type_name -> engine.Lookup
	45, // 76: engine.MemberInQueue.agent:type_name -> engine.Lookup
	45, // 77: engine.MemberInQueue.skill:type_name -> engine.Lookup
	45, // 78: engine.MemberCommunication.type:type_name -> engine.Lookup
	45, // 79: engine.MemberCommunication.resource:type_name -> engine.Lookup
	45, // 80: engine.MemberCommunicationCreateRequest.type:type_name -> engine.Lookup
	45, // 81: engine.MemberCommunicationCreateRequest.resource:type_name -> engine.Lookup
	29, // 82: engine.MemberService.CreateMember:input_type -> engine.CreateMemberRequest
	24, // 83: engine.MemberService.CreateMemberBulk:input_type -> engine.CreateMemberBulkRequest
	13, // 84: engine.MemberService.SearchMembers:input_type -> engine.SearchMembersRequest
	27, // 85: engine.MemberService.SearchMemberInQueue:input_type -> engine.SearchMemberInQueueRequest
	23, // 86: engine.MemberService.ReadMember:input_type -> engine.ReadMemberRequest
	22, // 87: engine.MemberService.UpdateMember:input_type -> engine.UpdateMemberRequest
	2,  // 88: engine.MemberService.PatchMember:input_type -> engine.PatchMemberRequest
	21, // 89: engine.MemberService.DeleteMember:input_type -> engine.DeleteMemberRequest
	15, // 90: engine.MemberService.DeleteMembers:input_type -> engine.DeleteMembersRequest
	16, // 91: engine.MemberService.ResetMembers:input_type -> engine.ResetMembersRequest
	19, // 92: engine.MemberService.SearchMemberAttempts:input_type -> engine.SearchMemberAttemptsRequest
	12, // 93: engine.MemberService.SearchAttempts:input_type -> engine.SearchAttemptsRequest
	12, // 94: engine.MemberService.SearchAttemptsHistory:input_type -> engine.SearchAttemptsRequest
	0,  // 95: engine.MemberService.AttemptsRenewalResult:input_type -> engine.AttemptRenewalResultRequest
	6,  // 96: engine.MemberService.AttemptResult:input_type -> engine.AttemptResultRequest
	5,  // 97: engine.MemberService.AttemptCallback:input_type -> engine.AttemptCallbackRequest
	3,  // 98: engine.MemberService.CreateAttempt:input_type -> engine.CreateAttemptRequest
	30, // 99: engine.MemberService.CreateMember:output_type -> engine.MemberInQueue
	26, // 100: engine.MemberService.CreateMemberBulk:output_type -> engine.MemberBulkResponse
	28, // 101: engine.MemberService.SearchMembers:output_type -> engine.ListMember
	28, // 102: engine.MemberService.SearchMemberInQueue:output_type -> engine.ListMember
	30, // 103: engine.MemberService.ReadMember:output_type -> engine.MemberInQueue
	30, // 104: engine.MemberService.UpdateMember:output_type -> engine.MemberInQueue
	30, // 105: engine.MemberService.PatchMember:output_type -> engine.MemberInQueue
	30, // 106: engine.MemberService.DeleteMember:output_type -> engine.MemberInQueue
	28, // 107: engine.MemberService.DeleteMembers:output_type -> engine.ListMember
	17, // 108: engine.MemberService.ResetMembers:output_type -> engine.ResetMembersResponse
	18, // 109: engine.MemberService.SearchMemberAttempts:output_type -> engine.ListMemberAttempt
	9,  // 110: engine.MemberService.SearchAttempts:output_type -> engine.ListAttempt
	8,  // 111: engine.MemberService.SearchAttemptsHistory:output_type -> engine.ListHistoryAttempt
	1,  // 112: engine.MemberService.AttemptsRenewalResult:output_type -> engine.AttemptRenewalResultResponse
	7,  // 113: engine.MemberService.AttemptResult:output_type -> engine.AttemptResultResponse
	7,  // 114: engine.MemberService.AttemptCallback:output_type -> engine.AttemptResultResponse
	4,  // 115: engine.MemberService.CreateAttempt:output_type -> engine.CreateAttemptResponse
